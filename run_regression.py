...
def save_results_kfold(filepath, kfold_data, precise_kernel):
    ...
    for i in range(args.kfold):
        ...
        results['test_rmse'].append(kfold_data[i]['test_rmse'])
...
def main():
    ...
    if args.kfold == -1: # static Train/Test split
        ...
        if args.precise_kernel == 0 or args.precise_kernel == 1:
            ...
            onefold_data = {'test_mnll': test_mnll, 'test_rmse': test_rmse, 'trained_model': model, 'X_train_indices': X_train_indices, 'X_test_indices': X_test_indices} 
        ...
        for train_index, val_index in kfold.split(X):
            ...
            if args.precise_kernel == 0 or args.precise_kernel == 1: # LRBF or ARD
                ...
                kfold_data_ker2.append({'test_mnll': current_fold_data_ker2['test_mnll'], 'test_rmse': current_fold_data_ker2['test_rmse'], 'trained_model': current_fold_data_ker2['trained_model'], 'X_train_indices': train_index, 'X_test_indices': val_index, 'precise_kernel': True})
            n_fold += 1
