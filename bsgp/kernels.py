...
class FullPrecisionRBF(gpflow.kernels.Kernel):  #gpflow.kernels.Kernel
    ...
    def __str__(self):
        param = 'Λ' if self.prior_precision_info['parametrization'] == 'Lambda' else 'L'
        ...
        prior_precision_info_str = prior_precision_info_str + ' [prior on ' + param + ']'
        str = [
